...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (password_verify($password, $found_user['hashed_password'])) {
        ...
        header("Location:login-m.php?invalid=true");
        exit;
    }
}
   ...
   <div class="container-fluid ">
       <div class="row">
           <div class="col d-none d-sm-block">
               <img src="img/login-m.jpg" alt="" class="img-fluid">
           </div> 
               ...
               <div class="align-self-center">
                    ...
                    <form method="POST" class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="register-m.php" class="btn btn-success btn-lg mb-4 w-100">Sign Up</a>
